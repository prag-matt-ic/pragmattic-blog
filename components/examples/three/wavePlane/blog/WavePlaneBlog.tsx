...
const WavePlaneBasicShaderMaterial = shaderMaterial(
  INITIAL_UNIFORMS,
  vertexShader,
  basicFragmentShader
);
const WavePlaneGradientShaderMaterial = shaderMaterial(
  INITIAL_UNIFORMS,
  vertexShader,
  gradientFragmentShader
);
const WavePlaneGridShaderMaterial = shaderMaterial(
  INITIAL_UNIFORMS,
  vertexShader,
  gridFragmentShader
);
...
const CanvasWrapper: FC<PropsWithChildren & { sectionClassName?: string }> = ({
  children,
  sectionClassName,
}) => (
  <section
    className={twMerge(
      "relative h-[704px] max-h-[70vh] w-full",
      sectionClassName
    )}
  >
    <Canvas
